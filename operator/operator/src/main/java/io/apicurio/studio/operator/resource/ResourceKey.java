...
import io.apicurio.studio.operator.resource.app.AppDeploymentDiscriminator;
import io.apicurio.studio.operator.resource.app.AppIngressDiscriminator;
import io.apicurio.studio.operator.resource.app.AppServiceDiscriminator;
import io.apicurio.studio.operator.resource.postgresql.PostgresqlDeploymentDiscriminator;
import io.apicurio.studio.operator.resource.postgresql.PostgresqlServiceDiscriminator;
import io.apicurio.studio.operator.resource.ui.UIDeploymentDiscriminator;
import io.apicurio.studio.operator.resource.ui.UIIngressDiscriminator;
import io.apicurio.studio.operator.resource.ui.UIServiceDiscriminator;
...
public class ResourceKey<R> {
    ...
    public static final String STUDIO_ID = "ApicurioStudioOperatorReconciler";
    ...
    public static final ResourceKey<ApicurioStudio> STUDIO_KEY = new ResourceKey<>(
            STUDIO_ID, ApicurioStudio.class,
            null, null
    );
    ...
    private ResourceDiscriminator<R, ApicurioStudio> discriminator;

    private Function<ApicurioStudio, R> factory;
}
